...
//1.	Необходимо реализовать консольную программу, которая бы фильтровала поток текстовой информации, подаваемой на вход,
//        и на выходе показывала лишь те строчки, которые содержат слово, переданное программе на вход в качестве аргумента
//        (ввод всех строк осуществляется последовательно, одна за другой, окончание ввода обозначается вводом пустой строки).
//        1)	В аргументах может быть передано не одно слово, а несколько (тогда должны вернуться строки, которые содержат
//        хотя бы одно из введённых слов);
//        2)	В качестве аргумента может быть задано не конкретное слово, а регулярное выражение (используется для проверки
//        КАЖДОГО СЛОВА ОТДЕЛЬНО).
